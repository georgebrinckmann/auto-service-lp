      ...
      <div className="container-landing relative z-10">
        ...
        <div className="max-w-3xl mx-auto space-y-5 mb-14">
          {items.map((item, i) => (
            <div
              key={i}
              className="flex gap-5 items-start bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-primary-foreground/15 transition-colors duration-300"
            >
