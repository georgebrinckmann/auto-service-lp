  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        feature: "0 8px 40px rgba(0, 0, 0, 0.08)",
        cta: "0 8px 24px rgba(245, 166, 35, 0.3)",
        "cta-hover": "0 12px 32px rgba(245, 166, 35, 0.4)",
        blue: "0 8px 24px rgba(20, 94, 238, 0.25)",
        "blue-hover": "0 12px 32px rgba(20, 94, 238, 0.35)",
        float: "0 20px 60px rgba(0, 0, 0, 0.12)",
        glow: "0 0 40px rgba(20, 94, 238, 0.15)",
      },
      keyframes: {
        "accordion-down": {
